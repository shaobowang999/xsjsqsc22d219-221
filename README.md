...
本仓库是三千思创基于 [Infinite Canvas](https://github.com/hero8152/Infinite-Canvas)
进行的独立维护版本。三千思创 GitHub 仓库是本版本唯一的开发、更新和发布入口；原作者仓库仅保留为只读参考、恢复出厂版本和来源声明。
